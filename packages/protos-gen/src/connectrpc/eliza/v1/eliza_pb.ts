...
export type SayRequestValid = SayRequest;

/**
 * Describes the message connectrpc.eliza.v1.SayRequest.
 * Use `create(SayRequestSchema)` to create a new message.
 */
export const SayRequestSchema: GenMessage<SayRequest, {validType: SayRequestValid}> = /*@__PURE__*/
...
export type SayResponseValid = SayResponse;

/**
 * Describes the message connectrpc.eliza.v1.SayResponse.
 * Use `create(SayResponseSchema)` to create a new message.
 */
export const SayResponseSchema: GenMessage<SayResponse, {validType: SayResponseValid}> = /*@__PURE__*/
